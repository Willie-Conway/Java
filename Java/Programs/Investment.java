...
* Willie Conway
*
* This program is the driver for the TheInvestor.java program.It tracks an investment
...
public class Investment {
    public static void main(String[] args) {
        ...
        TheInvestor investor1 = new TheInvestor(1001, 2000);
        /*create  investor2 a/c no 2001, balance $4000*/
        TheInvestor investor2 = new TheInvestor(2001, 4000);
        ...
        TheInvestor.setInteresetRate(interestRate);
