...
*
* The MySaleCheck Constructer receives sale as string, performs error checking to ensure time was enter in
...
public class MySaleCheck {
    ...
    /*Constructor for MySaleCheck*/
    public MySaleCheck(String sale) throws Exception{
